<template>
  <div class="flex flex-col w-screen h-screen bg-gray-100 justify-center items-center">
    <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 123 94.09">
      <defs>
        <style>
          ...
          animation: animate-stroke .5s .55s forwards cubic-bezier(0,1,.53,1);
          }

          #left-line-mask-path {
          stroke-dasharray: 38;
          stroke-dashoffset: -38;
          animation: animate-stroke .5s .6s forwards cubic-bezier(0,1,.53,1);
          }
          ...
          animation: move-stars .5s .5s forwards cubic-bezier(0,1,.53,1);
          }
          ...
          animation: move-stars .5s 525ms forwards cubic-bezier(0,1,.53,1);
          display: inherit;
          }
          ...
          .dot {
          animation: reveal-dots 0.45s .8s both cubic-bezier(0,1,.53,1);
          opacity: 0;
    ...
    <h1 class="mt-6 text-center font-black text-5xl italic text-gray-800">
      Thank you!
    </h1>
    <h2 class="mt-6 text-center font-bold text-2xl text-gray-700">
      Tap <span class="text-blue-600">Done</span> to continue browsing.
    </h2>
  </div>
</template>
