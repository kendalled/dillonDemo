<template>
  <section class="w-full flex h-auto justify-center -mt-20">
    <div class="tabs">
      <!-- TAB 1 -->
      <input
        id="tab-01"
      ...
      <!-- TAB 2 -->
      <input id="tab-02" v-model="selected" value="slide2" type="radio" name="tab">
      <label for="tab-02">
        <svg>
      ...
      <!-- TAB 3 -->
      <input id="tab-03" v-model="selected" value="slide3" type="radio" name="tab">
      <label for="tab-03">
        <svg>
      ...
      <!-- TAB 4 -->
      <input id="tab-04" v-model="selected" value="slide4" type="radio" name="tab">
      <label for="tab-04">
        <svg>
