<template>
  ...
  <div class="max-w-screen-xl mx-auto ">
    <div class="relative z-10 pb-8 bg-white sm:pb-16 md:pb-20 lg:max-w-2xl lg:w-full lg:pb-28 xl:pb-32">
      ...
      <div v-show="open" v-transition:enter="duration-150 ease-out" v-transition:enter-start="opacity-0 scale-95" v-transition:enter-end="opacity-100 scale-100" v-transition:leave="duration-100 ease-in" v-transition:leave-start="opacity-100 scale-100" v-transition:leave-end="opacity-0 scale-95" class="absolute top-0 inset-x-0 p-2 transition transform origin-top-right md:hidden" style="display: none;">
