      ...
      <div class="product__info">
        ...
        <div class="my-0">
          ...
          <div class="absolute -mt-32 text-right">
            <span class="mt-10 z-20 fixed font-semibold text-gray-600 text-xl pr-0">$<span class="font-semibold ml-1 line-through">329.99</span></span><!--<div style="margin-top:3.25rem;" class="absolute w-24 -ml-1 h-1 rounded bg-red-600 opacity-50" />-->
          </div>
...
.photo-main {
  ...
  background: radial-gradient(#286db8, #045bb8);
}
/* .photo-main .controls {
  display: flex;
